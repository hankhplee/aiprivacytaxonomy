  ...
  return (
    <div className="App">
      ...
      <div className="bottom-padding main-individual-padding"> {/* Added padding */}
        ...
        <h2 className="subtitle">Distortion refers to disseminating false or misleading information about people</h2> {/* Adjusted margin */}
          ...
          <div className="news-card">
            <div className="news-card-top">
              ...
              <div className="card-content" style={{ paddingTop: '15px' }}>
                <h2 className="medium-card-text">Prime Voice AI: a text-to-voice generator</h2>
