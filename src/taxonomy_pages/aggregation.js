  ...
  return (
    <div className="App">
      ...
      <div className="bottom-padding main-individual-padding"> {/* Added padding */}
        ...
        <h2 className="subtitle">Aggregation refers to combining various pieces of data about a person to make inferences beyond what is explicitly captured in those data.</h2> {/* Adjusted margin */}
          ...
          <div className="news-card">
            <div className="news-card-top">
              ...
              <div className="card-content" style={{ paddingTop: '15px' }}>
                ...
                <p className="tiny-card-text" style={{ paddingBottom: '50px' }}>National Data Analytics Solution (NDAS) (we should add something about that it is an UK policing/ UK law enforcement), uses a combination of AI and statistics to try to assess the risk of someone committing or becoming a victim of gun or knife crime. </p>
              </div>
            </div>
