  ...
  return (
    <div className="App">
      ...
      <div className="bottom-padding main-individual-padding"> {/* Added padding */}
        ...
        <h2 className="subtitle">Exclusion refers to the failure to provide end-users with notice and control over how their data is being used</h2> {/* Adjusted margin */}
          ...
          <div className="news-card">
            <div className="news-card-top">
              ...
              <div className="card-content" style={{ paddingTop: '15px' }}>
                <h2 className="medium-card-text">Airbnb assess users' trustworthiness scoring without user notice </h2>
