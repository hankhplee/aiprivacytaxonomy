  ...
  return (
    <div className="App">
      ...
      <div className="bottom-padding main-individual-padding"> {/* Added padding */}
        <h1 className="main-title">Phrenology and Physiognomy</h1>
        <h2 className="subtitle">Phrenology / Physiognomy refers to inferring personality, social, and emotional attributes about an individual from their physical attributes.</h2> {/* Adjusted margin */}
          ...
          <div className="news-card">
            <div className="news-card-top">
              ...
              <div className="card-content" style={{ paddingTop: '15px' }}>
                ...
                <p className="tiny-card-text" style={{ paddingBottom: '20px' }}>Class Technologies, a company that features in virtual classrooms, has been estimating students' engagement and emotions by analyzing their facial expressions without obtaining their consent; the analyzed insights were then provided to teachers. </p>
              </div>
            </div>
